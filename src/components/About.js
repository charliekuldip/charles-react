			    	...
			    	<div className="clearfix about-marquee table-full">
			    		<div className="clearfix outer">
			    			<div className ="clearfix inner">
					    		<h1>Charles Davis</h1>
					    		<h2>Front-End Engineer <br/> Creative Problem Solver</h2>
			    	...
			    	<div id="about-bio" className="clearfix block-container about-container">
			        	...
			        	<div className="clearfix about-p div-p">
			        		<div className="clearfix">
				        		<span>Interactive Developer for hire, specialized in front-end engineering. A creative problem solver in the physical and digital realm, I work in collaborations with designers, producers, and developers to build projects from scratch and bring ideas to&nbsp;fruition.</span>
							...
							<div className="clearfix">
								...
								<BgImageLoader className="about-bg c-pigeons" src="/src/img/about/c-pigeons.jpg" key="c-pigeons" />
							</div>
